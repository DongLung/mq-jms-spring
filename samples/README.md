...
All samples are now based on Spring Boot 4. The "boot4" suffix to directory names has been removed.
...
* s4 - Shows how to connect to multiple queue managers in the same application and using an XA transaction
